...
|sith| supports many of the widely used Python features:
...
- class decorators (py3k feature, are being ignored too, until I find a use
  case, that doesn't work with |sith|)
...
completion. |sith| is **NOT** a Python compiler, that tries to correct you. It is
a tool that wants to help you. But **YOU** have to know Python, not |sith|.
...
|sith|, which preload stuff. However, once loaded, this is not a problem anymore.
The same is true for huge modules like ``PySide``, ``wx``, etc.

**Security**

Security is an important issue for |sith|. Therefore no Python code is executed.
